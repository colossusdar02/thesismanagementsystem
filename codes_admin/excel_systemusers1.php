...
<?php  
//excel_systemusers1.php  
$connect = mysqli_connect("localhost", "root", "", "tms");
$output = '';
if(isset($_POST["report_position"]))
{
 $user_position = $_POST["position"];
 $query = "SELECT * FROM admin WHERE position='$user_position'";
...
<body>
	...
	<div id="calendar">
		<form action="excel_systemusers1.php" method="POST">
			...
			</select>&nbsp;<button name="report_position">GENERATE</button> &nbsp; <span id="error">Error: No Data Read!</span></div>
		</form>
		...
		<form action="excel_systemusers3.php" method="POST">
			...
			<div><button name="report_allusers">GENERATE</button></div>
		</form>
	</div>
