<?php 
		if (isset($_POST['submit'])){
			...
			$passcheck = "SELECT * FROM admin WHERE pass = '$pass'";
			$check = mysql_query($passcheck);
			...
			<body>
				...
				<div class="body">
					<form action="users_remove.php" method="post" class="form-horizontal" enctype="multipart/form-data" style="width:95%;">
					<?php
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
						  <input type="email" class="form-control" name="user" value="<?php echo $user ?>" readonly>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="col-sm-offset-2 col-sm-10">
						<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>Password did not match!
					</div>
				</div>
				<br/>
			</body>
			...
			<?php
				...
				mysql_query("delete from admin where tmsadminid='$tmsadminid'") or die(mysql_error());
