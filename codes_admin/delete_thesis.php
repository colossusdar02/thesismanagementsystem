...
<body>
	...
	<br/><br/><br/><br/><br/><br/><br/>
		<div class="body">
		<br/><br/>
		<form action="delete.php" method="GET" class="form-horizontal" style="width:95%;">
		<?php
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" class="form-control" name="thesistitle" value="<?php echo $thesistitle ?>" readonly>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">Authors</label>
			<div class="col-sm-10">
			  <input type="text" class="form-control" name="thesisauthors" value="<?php echo $thesisauthors ?>" readonly>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">School Year</label>
			<div class="col-sm-10">
			  <input type="text" class="form-control" name="thesisschoolyear" value="<?php echo $thesisschoolyear ?>" readonly>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">College</label>
			<div class="col-sm-10">
			<select class="form-control" id="thesiscollege" name="thesiscollege" class="form-control" readonly>
			  ...
			  <option value="COLAW">COL</option>
			  <option value="CONURSING">CON</option>
			</select>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" class="form-control" name="thesiscourse" value="<?php echo $thesiscourse ?>" readonly>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
			  <input type="submit" name="submit" class="btn btn-default" value="Delete" style="width:100px">
			</div>
			<div>
				<br/><br/>
			</div>
