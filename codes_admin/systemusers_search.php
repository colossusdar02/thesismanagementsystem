...
<body>
	...
	<div id="searchBox">
		<form action="systemusers_search.php" method="GET">
			<input type="text" name="users" value="<?php echo $search ?>" placeholder="Search">&nbsp;<button type="submit"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>&nbsp;Search</button>
		</form>
	</div>
	<?php 
	...
	$statement = "admin WHERE tmsadminfullname LIKE '%".$search."%' || user LIKE '%".$search."%' || status LIKE '%".$search."%' || position LIKE '%".$search."%'"; //you have to pass your query over here
