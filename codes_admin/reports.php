...
<body>
	...
	<div id="buttonGenerate1">
		<button onclick="location.href='/sysiac1/codes_admin/reports_thesis.php'">REPORT OF THESIS INVENTORY</button>
	</div>
	<div id="buttonGenerate2">
		<button onclick="location.href='/sysiac1/codes_admin/reports_users.php'">LIST OF SYSTEM USERS</button>
	</div>
