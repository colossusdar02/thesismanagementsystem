...
session_start();
	if(!isset($_SESSION["sess_user"]) && !isset($_SESSION["sess_id"])){
		...
		include('inc/db.php');
		$id = $_SESSION['sess_id'];
		$sql="SELECT * FROM admin WHERE tmsadminid = $id ";
		$res = mysql_query($sql);
?>
<html>
<head>
...
<body>
	...
	<div class="body">
		<br/><br/><br/><br/>
		<form action="myaccount_save.php" method="POST" class="form-horizontal" style="width:95%;">
		<?php
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" class="form-control" name="tmsadminid" value="<?php echo $tmsadminid ?>" readonly>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label">Username/E-mail</label>
			<div class="col-sm-10">
			  <input type="email" class="form-control" name="user" value="<?php echo $user ?>" required>
			</div>
		</div>
		<div class="form-group">
