...
<body>
	<table id="tableCollege">
		<tr>
					...
					<td><input type="text" class="form-control" name="tmssearch" placeholder="Search" style="width:500px"></td>
					<td>&nbsp;</td>
	...
	$statement = "thesis WHERE thesiscollege = 'cbeam'"; //you have to pass your query over here
	...
	<table align="center" style="width:65%">
			<?php
					if(mysql_num_rows($res)==0){
						?>
						<td><center>No files to post!</center></td>
						<?php
					}
					else{
