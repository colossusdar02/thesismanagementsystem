...
<body>
	...
	<div id="searchBox">
		<form action="search_thesis.php" method="GET">
			<input type="text" name="tmssearch" value="<?php echo $search?>" placeholder="Search">&nbsp;<button><span class="glyphicon glyphicon-search" aria-hidden="true"></span>&nbsp;Search</button>
		</form>
	</div>
	<?php 
	...
	WHERE
	thesistitle LIKE '%".$search."%' || thesisauthors LIKE '%".$search."%' || thesisschoolyear LIKE '%".$search."%' || thesiscollege LIKE '%".$search."%' || thesiscourse LIKE '%".$search."%' || thesisdateuploaded LIKE '%".$search."%' "; //you have to pass your query over here
