...
<body>
	...
	<div id="calendar">
		...
		<form action="excel_systemusers2.php" method="POST">
			...
			</select>&nbsp;<button name="report_status">GENERATE</button> &nbsp; <span id="error">Error: No Data Read!</span></div>
		</form>
