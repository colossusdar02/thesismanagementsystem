<?php 
		if (isset($_POST['submit'])){
			...
			<?php
				...
				mysql_query("update admin set tmsadminfullname = '$tmsadminfullname', position = '$position', status = '$status'  where tmsadminid = '$tmsadminid'")or die(mysql_error());
				?>
				<?php
					session_start();
					if(!isset($_SESSION["sess_user"]) && !isset($_SESSION["sess_id"])){
				...
				<body>
					...
					<div class="body">
						...
						<div class="col-sm-offset-2 col-sm-10">
							<span class="glyphicon glyphicon-ok" aria-hidden="true"></span>Successfully updated!
						</div>
					</div>
					<br/>
				</body>
